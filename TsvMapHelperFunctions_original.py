"""
I had to make changes to this helper function, this copy is the original script from Dr. K

Helper functions for working with TSV map files from tagmentation analysis.
